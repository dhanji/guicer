...
public class OptionsTest {
  ...
  @Test
  public final void testTypedOptionsAbstractClassWithNamespaceFromYamlFile() throws URISyntaxException {
    File yaml = new File(Options.class.getResource("options.yaml").toURI());
    MyAbstractOpts opts = Guice.createInjector(new OptionsModule(yaml, "staging")
        .options(MyAbstractOpts.class))
        .getInstance(MyAbstractOpts.class);
